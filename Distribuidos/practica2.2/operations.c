...
int registerU(char *user)
{
    ...
    if(exists == 0){
        ...
        exists = 0;
        printf("SS> USERNAME IN USE\n");
        return 1; 
    }
    printf("SS> REGISTER OK\n");
    sqlite3_close(registered_db); //Cerramos la base de datos
    return 0;
}
...
int unregisterU(char *user)
{
    ...
    if(exists == 1){
        ...
        printf("SS> USER DOES NOT EXIST\n");
        return 1;
    }
    printf("SS> UNREGISTER OK\n");
	sqlite3_close(active_db);
    return 0;
}
...
*/
int connectU(char *user, char *ip, int port)
{
    //Abrir la base de datos de registrados
    registered_rc = sqlite3_open("registered.db", &registered_db);
	if(registered_rc) fprintf(stderr, "Can't open database: %s\n", sqlite3_errmsg(registered_db));
    ...
    if(exists == 1){
        ...
        if(exists == 0){
            ...
            exists = 0;
            printf("SS> USER ALREADY CONNECTED\n");
            return 2;
        }
    }else{
        printf("SS> CONNECT FAIL, USER DOES NOT EXIST\n");
        return 1;
    }
    printf("SS> CONNECT OK\n");
...
int disconnectU(char *user)
{
    ...
    if(exists == 1){
        ...
        if(exists == 1){
            ...
            printf("SS> DISCONNECT FAIL / USER NOT CONNECTED\n");
            return 2;
        }
    }else{
        printf("SS> DISCONNECT FAIL / USER DOES NOT EXIST\n");
        return 1;
    }
    printf("SS> DISCONNECT OK\n");
	sqlite3_close(active_db);
    return 0;
}
    ...
    if(exists == 1){
        ...
        if(exists == 1){
            ...
            if(exists == 0){
                ...
                exists = 0;
                sqlite3_close(active_db);
                printf("SS> PUBLISH FAIL, CONTENT ALREADY PUBLISHED\n");
                return 3;
            }
        }else{
            sqlite3_close(active_db);
            printf("SS> PUBLISH FAIL, USER  NOT CONNECTED\n");
            return 2;
        }   
    }else{
        sqlite3_close(active_db);
        printf("SS> PUBLISH FAIL, USER DOES NOT EXIST\n");
        return 1;
    }
    printf("SS> PUBLISH OK\n");
	sqlite3_close(active_db);
    return 0;
}
    ...
    if(exists == 1){
        ...
        if(exists == 1){
            ...
            if(exists == 1){
                ...
                sqlite3_close(active_db);
                printf("SS> DELETE FAIL, CONTENT NOT PUBLISHED\n");
                return 3;
            }
        }else{
            sqlite3_close(active_db);
            printf("SS> DELETE FAIL, USER  NOT CONNECTED\n");
            return 2;
        }   
    }else{
        sqlite3_close(active_db);
        printf("SS> DELETE FAIL, USER DOES NOT EXIST\n");
        return 1;
    }
...
int list_users(char *user, char ***list)
{
    ...
    if(exists == 1){
        ...
        printf("SS> LIST_USERS FAIL, USER DOES NOT EXIST\n");
        return -1;
    }
    printf("SS> LIST_USERS OK\n");
	sqlite3_close(active_db);
    return results;
}
...
int list_content(char *user1, char *user2, char *** list)
{
    ...
    if(exists == 1){
        ...
        if(exists == 1){
            ...
            printf("SS> LIST_CONTENT FAIL, USER NOT CONNECTED\n");
            return -2;
        }
    }else{
